# -*- coding: utf-8 -*-
# @Time        : 2022/10/25 20:31
# @Author      : ssxy00
# @File        : train_without_persona_without_mc_without_type.py
    ...
    for dataset_name, dataset in raw_dataset.items():
        for dialog in dataset:
            for utterance in dialog["utterances"]:
                ...
                instance = build_input_from_segments(history, utterance["candidates"][-1], tokenizer, True)
