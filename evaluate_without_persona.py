# -*- coding: utf-8 -*-
# @Time        : 2022/10/2 14:46
# @Author      : ssxy00
# @File        : evaluate_without_persona.py
# @Description :
...
from train_without_persona import SPECIAL_TOKENS, build_input_from_segments, pad_dataset
...
def get_data_loaders(args, tokenizer):
    ...
    for dialog in raw_dataset:
        for utterance in dialog["utterances"]:
            ...
            lm_labels = True
            instance = build_input_from_segments(history, tgt, tokenizer, lm_labels)
    ...
    for input_name in ["input_ids", "lm_labels", "token_type_ids"]:
...
def run():
    ...
    parser.add_argument("--dataset_path", type=str,
                        default="/home1/sxy/transfer-learning-conv-ai/datasets/dailydialog/dailydialog_test.json",
                        help="Path or url of the dataset. If empty download from S3.")
    parser.add_argument("--dataset_cache", type=str,
                        default='/home1/sxy/transfer-learning-conv-ai/datasets/dailydialog/dailydialog_test.cache',
                        help="Path or url of the dataset cache")
    parser.add_argument("--model_checkpoint", type=str,
                        default="/home1/sxy/transfer-learning-conv-ai/runs/dailydialog/1e-4/Oct02_15-04-01_IW4202/",
                        help="Path, url or short name of the model")
    parser.add_argument("--optimal_step", type=int, default=11155, help="optimal checkpoint to load")
    ...
    with torch.no_grad():
        for i, data in enumerate(tqdm_data):
            input_ids, lm_labels, token_type_ids = tuple(input_tensor.to(args.device) for input_tensor in data)
            lm_loss = model(
