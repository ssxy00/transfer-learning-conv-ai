lr=3e-4
SAVE_DIR=/home1/sxy/transfer-learning-conv-ai/runs/multiwoz_without_mc_without_type_length_limit/$lr
CUDA_VISIBLE_DEVICES=2 python train_without_persona_without_mc_without_type_length_limit.py \
