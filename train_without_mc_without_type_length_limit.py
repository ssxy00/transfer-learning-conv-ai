...
from transformers import (AdamW, OpenAIGPTLMHeadModel, OpenAIGPTTokenizer,
                                  GPT2DoubleHeadsModel, GPT2Tokenizer, WEIGHTS_NAME, CONFIG_NAME, OpenAIGPTConfig)
        ...
        for dialog in dataset:
            ...
            for _ in range(args.personality_permutations):
                for utterance in dialog["utterances"]:
                    ...
                    instance = build_input_from_segments(persona, history, utterance["candidates"][-1], tokenizer, args.max_input_len, True)
